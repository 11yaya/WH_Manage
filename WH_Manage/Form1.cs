...
namespace WH_Manage
{
    public partial class Form1 : Form
    {
        ...
        {
            public static string dbFile = Application.StartupPath + @"\log.db"; //log.db要放在【bin\Debug底下】
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // 抓取textbox的資料
            _name = comboBox1.Text + " " + comboBox2.Text;
        ...
        void manipulatePdf(String src)
        {
            ...
            PdfFont font = PdfFontFactory.CreateFont(@"c:/Windows/fonts/kaiu.ttf", PdfEncodings.IDENTITY_H, true);
